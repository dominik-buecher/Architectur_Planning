...
loaded_state_dict = torch.load('models/dqn_model_standart_cow0.pth')
...
while not done:
    ...
    reward = grid_window.get_reward(state, next_row, next_col, action, action_counter, num_cows, consecutive_unvisited_count)
    total_reward += reward
