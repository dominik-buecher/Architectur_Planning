...
#         self.fc1 = nn.Linear(64 * 5 * 5, 128)  # Anpassen der Größe der versteckten Schicht
...
#         x = x.reshape(x.size(0), -1)  # Flattening mit reshape
...
if train:
    ...
    for episode in range(max_episodes):
        ...
        while not done:
            ...
            reward = grid_window.get_reward(next_row, next_col)
...
# loaded_state_dict = torch.load('models/dqn_model_onehot.pth')
