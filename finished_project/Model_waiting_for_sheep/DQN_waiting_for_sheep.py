...
if train:
    ...
    for episode in range(max_episodes):
        ...
        if episode % 5 == 0:
            ...
            print("Saving model...")
            torch.save(dqn_agent.policy_net.state_dict(), 'Model_waiting_for_sheep/dqn_model_5cow_5_waiting_1.pth')
            print("Model saved!")
...
dqn_agent = DQNAgent(input_channels, output_size)
loaded_state_dict = torch.load('Model_waiting_for_sheep/dqn_model_5cow_5_waiting.pth')
dqn_agent.policy_net.load_state_dict(loaded_state_dict)
initial_state, cows_pos = grid_window.get_state()
test_model(cows_pos)
