...
class GridWindow:
    ...
    def get_state(self):
        ...
        tensor = torch.zeros(self.rows, self.cols, 4)
        ...
        tensor[target_row, target_col, 2] = 1
    ...
    def get_reward(self, future_row, future_col, action):
        ...
        # Liste der möglichen Positionen neben dem Mäher
        adjacent_positions = [(mower_row-1, mower_col), (mower_row+1, mower_col), 
                                (mower_row, mower_col-1), (mower_row, mower_col+1)]
        ...
        for cow in self.cows:
            ...
            # überprüft ob eine kuh direkt neben dem mower ist
            for pos in adjacent_positions:
                if (pos[0] == cow_row) and (pos[1] == cow_col):
                    if action == 4:
                        reward += 10
        ...
        if (future_row == target_row) and (future_col == target_col):
            print("Geschafft!")
            reward += 30
