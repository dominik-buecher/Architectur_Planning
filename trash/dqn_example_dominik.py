...
for episode in range(max_episodes):
    ...
    while not done:
        ...
        next_row, next_col = calculate_next_state(action)
        #row_next, col_row = grid_window.get_future_state(state, action)
        ...
        #transition = Transition(state, action, [row_next, col_row], reward, done)
        ...
        if len(replay_memory) > batch_size:
            ...
            # Überprüfen Sie, ob das Maximum korrekt ausgewählt wird
